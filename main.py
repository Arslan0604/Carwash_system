...
def menu():
    while True:
        ...
        if choice == "1":
            plate = input("Nomer machine: ")
            ctype = input("Model (Sedan, SUV, etc.): ")
            service = input("Haysy ishler edilya (Gubka-aparat, Ichi-dashy, Dine-dashy, etc.): ")
